...
public interface IMPlusHttp {
    ...
    Request directBindBluetoothDevice(String ip, String type, VolleyResponse.Listener response);

    Request directUnBindBluetoothDevice(String ip, String type, VolleyResponse.Listener response);

    Request directGetDeviceInfo(String ip, String type, VolleyResponse.Listener response);
